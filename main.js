...
function Face() {
  this.graphics = {
    face: faceAssets.putin,
    slapLeft: faceAssets.slapLeftBlur0,
    slapRight: faceAssets.slapRightBlur0,
  };
  this.iWidth = 253;
  this.iHeight = 306;
  this.ratio = 2.5;
...
function preload() {
  ...
  faceAssets = {
    ...
    slapLeftBlur0: loadImage("assets/putin_slap_l.png"),
    slapLeftBlur1: loadImage("assets/putin_slap_l_blr1.png"),
    slapLeftBlur2: loadImage("assets/putin_slap_l_blr2.png"),
    slapLeftBlur3: loadImage("assets/putin_slap_l_blr3.png"),
    slapRightBlur0: loadImage("assets/putin_slap_r.png"),
    slapRightBlur1: loadImage("assets/putin_slap_r_blr1.png"),
    slapRightBlur2: loadImage("assets/putin_slap_r_blr2.png"),
